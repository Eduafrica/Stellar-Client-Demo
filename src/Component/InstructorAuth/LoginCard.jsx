...
import { instructorLogin } from '../../Helpers/api';
                ...
                <div className="flex flex-col w-[80%] gap-[28px] items-center justify-center">
                    ...
                    <div className="w-full flex flex-col gap-[30px]">
                        ...
                        <div className="w-full flex flex-col gap-[24px]">
                           ...
                           {/**BUTTON */}
                           <div onClick={handleRegister} className={`btn`}>{ loading ? 'Please Wait' : 'Login' }</div>
                        </div>

                    </div>

                    <div className="text-[12px] text-text-secondary font-medium">
                        New here? <Link to='/instructor/register' className='text-primary'>Go here</Link>
                    </div>
