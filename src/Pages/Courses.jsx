...
function Courses({ setSelectedCourse }) {
  ...
  const handleCategoryChange = (slug) => {
    ...
    setSearchTerm('');
    navigate('/courses'); // clear search query from URL
  };
        ...
        <div className="pt-16 md:pt-[4rem]">
          ...
          <div className="mt-6 w-full md:w-[80%] lg:w-[60%]">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-2">
              <p className="text-[#0F1114] text-3xl md:text-[48px] font-medium whitespace-nowrap w-full md:w-auto text-center md:text-left">
                Explore Courses
              </p>
